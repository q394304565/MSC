...
public final class Decoder {
	...
	public DecoderResult decode(BitMatrix bits, Map<DecodeHintType, ?> hints) throws FormatException, ChecksumException {
		...
		try {
			...
			/*
			 * Since we're here, this means we have successfully detected some kind of version and format information when mirrored. This is a good sign, that
			 * the QR code may be mirrored, and we should try once more with a mirrored content.
			 */
	...
	/**
	 * <p>
	 * Given data and error-correction codewords received, possibly corrupted by errors, attempts to correct the errors in-place using Reed-Solomon error
	 * correction.
	 * </p>
	 *
	 * @param codewordBytes
